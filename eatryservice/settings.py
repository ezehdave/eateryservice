"""
Django settings for eatryservice project.
...
SECRET_KEY = 'django-insecure-%adtcekf##(*ch*7^v#k3zfh!fu8gc5!rl7n0cwa5%)l_zul-q'
...
'['
WSGI_APPLICATION = 'eatryservice.wsgi.application'
